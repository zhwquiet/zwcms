...
<div class="main-container" id="main-container">
    ...
    <div class="breadcrumbs" id="breadcrumbs">
        <ul class="breadcrumb">
            ...
            <li><a href="<?php echo U('Block/index',array('isprevpage'=>1));?>">区块管理</a></li>
            <li>新建区块</li>
        </ul><!-- /.breadcrumb -->
                        ...
                        <form class="formname" method="post">
                            ...
                            <div class="form_group">
                                ...
                                <div class="form_input">
                                    <?php if(!empty($info["name"])): echo ($info["name"]); ?>
                                        <?php else: ?>
                                        <input type="text" name="name" size="30" maxlength="20" class="ip" data-rule="区块名称:required;letters;" />　<span>只能为字母，保存后不能更改</span><?php endif; ?>
                                </div>
                            </div>
                            <div class="form_group">
                                <div class="form_txt">区块说明：</div>
                                <div class="form_input"><input type="text" name="desc" size="50" maxlength="100" class="tt" data-rule="区块说明:required;" value="<?php echo ($info["desc"]); ?>"></div>
                            </div>
                            <div class="form_group">
                                <div class="form_txt">区块内容：</div>
                                <div class="form_input">
                                    <textarea name="content" id="container" class="tt" data-rule="区块内容:required;"><?php echo ($info["content"]); ?></textarea>
                                </div>
                            </div>
                            <div class="form_group">
                                <div class="form_bnt">
                                    ...
                                    <a href="<?php echo U('Block/index',array('isprevpage'=>1));?>" class="btn btn-white btn-warning btn-round">
...
<script src="/Public/Admin/js/main.js"></script>
    ...
    <script>
        ...
        if(infoId){
            var loadurl = "<?php echo U('Block/index',array('isprevpage'=>1));?>";
        }else{
            var loadurl = "<?php echo U('Block/index');?>";
        }
        $(".formname").MotorsSubmit({
            ajaxurl:"<?php echo U('Block/add');?>",
            loadurl:loadurl
        });
    </script>
