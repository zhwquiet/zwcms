...
<div class="main-container" id="main-container">
    ...
    <div class="breadcrumbs" id="breadcrumbs">
        <ul class="breadcrumb">
            ...
            <li><a href="<?php echo U('Book/Index',array('isprevpage'=>1));?>">留言管理</a></li>
            <li>
                留言配置
            </li>
        </ul><!-- /.breadcrumb -->
                    ...
                    <div class="table_form">
                        <form class="form-horizontal formname" method="post">
                            <div class="form_group">
                                <div class="form_txt">留言开关：</div>
                                <div class="form_input">
                                    <label class="checklabel">
                                        <input name="bookOpen" type="radio" class="ace" value="1" <?php if($bookConfig['bookopen'] == 1): ?>checked<?php endif; ?>>
                                        <span class="lbl"> 开启</span>
                                    </label>
                                    <label class="checklabel">
                                        <input name="bookOpen" type="radio" class="ace" value="0" <?php if($bookConfig['bookopen'] == 0): ?>checked<?php endif; ?>>
                                        <span class="lbl"> 关闭</span>
                                    </label>
                                </div>
                            </div>
                            <div class="form_group">
                                <div class="form_txt">留言审核：</div>
                                <div class="form_input">
                                    <label class="checklabel">
                                        <input name="bookLock" type="radio" class="ace" value="1" <?php if($bookConfig['bookcheck'] == 1): ?>checked<?php endif; ?>>
                                        <span class="lbl"> 开启</span>
                                    </label>
                                    <label class="bookLock">
                                        <input name="bookLock" type="radio" class="ace" value="0" <?php if($bookConfig['bookcheck'] == 0): ?>checked<?php endif; ?>>
                                        <span class="lbl"> 关闭</span>
                                    </label>
                                </div>
                            </div>
                            <div class="form_group">
                                <div class="form_bnt">
                                    ...
                                    <a href="<?php echo U('Book/Index',array('isprevpage'=>1));?>" class="btn btn-white btn-warning btn-round">
...
<script src="/Public/Admin/js/main.js"></script>
    ...
    <script>
        $(".formname").MotorsSubmit({
            ajaxurl:"<?php echo U('Book/bookConfig');?>"
        });
    </script>
