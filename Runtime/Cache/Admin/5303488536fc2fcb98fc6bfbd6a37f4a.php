                ...
                <div class="col-xs-12">
                    <div class="table_form">
                        <div class="form_group">
                            ...
                            <div class="form_input"><?php echo ($info["name"]); ?></div>
                        </div>
                        <div class="form_group">
                            <div class="form_txt">调用代码：</div>
                            <div class="form_input">
                            <textarea id="content" rows="4" style="width:96%;" class="tt">{:W('Block/index',array('name'=>'<?php echo ($info["name"]); ?>'))}</textarea>
                            <br>
                            <span>将代码放到相应的模板里即可</span>
                            </div>
                        </div>
                        <div class="form_group">
                            <div class="form_bnt">
