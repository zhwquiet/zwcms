            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="nav_menu">
                        ...
                        <ul>
                            <li class="dropdown"><a href="javascript:;"><span class="icon iconfont icon-iconplsd"></span>批量操作↓</a><dl>
                            ...
                            <li><a href="<?php echo U('Comment/comConfig');?>"><span class="icon iconfont icon-set"></span>评论配置</a></li>
                        </ul>
                    </div>
    ...
    <script>
        $(function(){
            ...
            $(".delsome").click(function(){
                ...
                if(ids){
                    alertlayer({
                        ajaxurl:"<?php echo U('Comment/delSome');?>",
                        content:"确定要删除？不可恢复！",
                        ids:ids,
                        isremovetr:true
                    });
        ...
        function doset(act){
            ...
            if(idarr){
                $.ajax({
                    type:"get",
                    url:"<?php echo U('Comment/comLock');?>",
                    data:{"idArr":idarr,"act":act},
                    dataType:"json",
        ...
        var durl = "<?php echo U('Comment/commentPage');?>";
