                    ...
                    <div class="table_form">
                        <form class="form-horizontal formname" method="post">
                            <div class="form_group">
                                <div class="form_txt">微信号：</div>
                                <div class="form_input"><input type="text" name="wechat_num" size="50" class="ip" value="<?php echo ($weixinInfo["wechat_num"]); ?>" /></div>
                            </div>
                            <div class="form_group">
                                <div class="form_txt">AppID：</div>
                                <div class="form_input">
                                    <input type="text" name="appid" size="50" class="ip" value="<?php echo ($weixinInfo["appid"]); ?>" />
                                </div>
                            </div>
                            <div class="form_group">
                                <div class="form_txt">AppSecret：</div>
                                <div class="form_input">
                                    <input type="text" name="appsecret" size="50" class="ip" value="<?php echo ($weixinInfo["appsecret"]); ?>" />
                                </div>
                            </div>
                            <div class="form_group">
                                <div class="form_txt">EncodingAESKey：</div>
                                <div class="form_input">
                                    <input type="text" name="encodingaeskey" size="50" class="ip" value="<?php echo ($weixinInfo["encodingaeskey"]); ?>" />
                                </div>
                            </div>
                            <div class="form_group">
                                <div class="form_txt">公众号类型：</div>
                                <div class="form_input" style="width:200px;">
                                    <select name="type" class="ip beautify_input">
                                        <option value="1" <?php if(($weixinInfo["type"]) == "1"): ?>selected<?php endif; ?>>订阅号</option>
                                        <option value="2" <?php if(($weixinInfo["type"]) == "2"): ?>selected<?php endif; ?>>服务号</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form_group">
                                <div class="form_txt">服务器URL：</div>
                                <div class="form_input">
                                    <input type="text" name="url" size="50" class="ip" value="<?php echo ($weixinInfo["url"]); ?>" disabled/>
                                </div>
                            </div>
                            <div class="form_group">
                                <div class="form_txt">Token(令牌)：</div>
                                <div class="form_input">
                                    <input type="text" name="token" size="50" class="ip" value="<?php echo ($weixinInfo["token"]); ?>" disabled/>
                                </div>
                            </div>
                            <div class="form_group">
                                <div class="form_bnt">
...
<script src="/Public/Admin/js/main.js"></script>
    ...
    <script>
        $(".formname").MotorsSubmit({
            ajaxurl:"<?php echo U('Setting/weixin');?>",
