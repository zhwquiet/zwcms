...
<div class="main-container" id="main-container">
    ...
    <div class="breadcrumbs" id="breadcrumbs">
        <ul class="breadcrumb">
            ...
            <li>
                <a href="<?php echo U('Expand/link',array('isprevpage'=>1));?>">友情链接</a>
            </li>
        ...
        <div class="page-content-area">
            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="nav_menu">
                        <ul>
                            <li><a href="<?php echo U('Expand/classAdd');?>"><span class="icon iconfont icon-liebiaoshouqi"></span>添加类别</a></li>
                        </ul>
                    </div>
...
<script src="/Public/Admin/js/main.js"></script>
    ...
    <script>
        var durl = "<?php echo U('Expand/catePage');?>";
        isprevpage="<?php echo ($_GET['isprevpage']); ?>";
        var pageMethod = 'linkcate';
