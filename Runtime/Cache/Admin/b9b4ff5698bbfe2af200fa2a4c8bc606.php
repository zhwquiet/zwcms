            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="nav_menu">
                        ...
                        <ul>
                            <li><a href="<?php echo U('Weixin/keywordsAdd');?>"><span class="icon iconfont icon-liebiaoshouqi"></span>添加关键词</a></li>
                        </ul>
                    </div>
...
<script src="/Public/Admin/js/main.js"></script>
    ...
    <script>
        ...
        var durl = "<?php echo U('Weixin/keywordsAjax');?>";
