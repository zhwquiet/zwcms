                        ...
                        <form class="formname" method="post">
                            ...
                            <div class="form_group">
                                ...
                                <div class="form_input">
                                    <input type="text" name="title" size="50" maxlength="255" class="ip" id="t0" data-rule="标题:required;" value="<?php echo ($contentinfo["title"]); ?>"/>
                            ...
                            <div class="form_group">
                                ...
                                <div class="form_input">
                                    <input type="text" name="url" size="50" maxlength="50" value="<?php echo ($contentinfo["url"]); ?>" class="ip" data-rule="链接:required;url;"/>
...
<script src="../Public/Admin/js/main.js"></script>
    ...
    <script>
        $(".formname").MotorsSubmit({
            ...
            ajaxurl:"<?php echo U('Content/savemodelurl');?>",
            loadurl:"<?php echo ($referer["url"]); ?>&isprevpage=1"
        });
    </script>
