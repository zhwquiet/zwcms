                        ...
                        <form class="form-horizontal formname" method="post">
                            ...
                            <div class="form_group">
                                ...
                                <div class="form_input">
                                    <input type="text" name="adminname" size="30" maxlength="20" class="ip" value="<?php echo ($adminInfo["adminname"]); ?>" <?php if(!empty($adminInfo)): ?>disabled="disabled"<?php endif; ?> /><span>不可修改</span></div>
                            </div>
                            <div class="form_group">
                            ...
                            <div class="form_group">
                                ...
                                <div class="form_input">
                                    ...
                                    <label class="checklabel">
                                        <input name="islock" type="radio" class="ace" value="0" <?php if($adminInfo['islock'] == 0): ?>checked<?php endif; ?>>
                                        <span class="lbl"> 锁定</span>
                                    </label>
                                    <label class="checklabel">
                                        <input name="islock" type="radio" class="ace" value="1" <?php if($adminInfo['islock'] == 1): ?>checked<?php endif; ?>>
...
<script src="/Public/Admin/js/main.js"></script>
    ...
    <script>
        $(".formname").MotorsSubmit({
            ajaxurl:"<?php echo U('System/addAdmin');?>",
