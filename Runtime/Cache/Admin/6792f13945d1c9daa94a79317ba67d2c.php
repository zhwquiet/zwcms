                ...
                <div class="col-xs-12">
                    <div class="nav_menu">
                        ...
                        <ul>
                            ...
                            <li><a href="<?php echo U('Book/bookConfig');?>"><span class="icon iconfont icon-set"></span>留言配置</a></li>
                        </ul>
                    </div>
    ...
    <script>
        ...
        $(function(){
            ...
            $(".delsome").click(function(){
                ...
                if(ids){
                    alertlayer({
                        ajaxurl:"<?php echo U('Book/delSome');?>",
                        content:"确定要删除？不可恢复！",
                        ids:ids,
                        isremovetr:true
                    });
        ...
        var durl = "<?php echo U('Book/bookPage');?>";
