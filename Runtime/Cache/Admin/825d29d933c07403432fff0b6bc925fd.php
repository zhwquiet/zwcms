...
<div class="main-container" id="main-container">
    ...
    <div class="breadcrumbs" id="breadcrumbs">
        <ul class="breadcrumb">
            ...
            <li><a href="<?php echo U('Slide/index');?>"><?php echo ($classtitle); ?></a></li>
            <li><a href="<?php echo U('Slide/listpage',array('classid'=>$classid));?>">列表管理</a></li>
            <li>添加</li>
        </ul><!-- /.breadcrumb -->
                ...
                <div class="col-xs-12">
                    <div class="table_form">
                        <form class="formname" method="post">
                            ...
                            <input type="hidden" name="slide_id" value="<?php echo ($classid); ?>"/>
                            <div class="form_group">
                                <div class="form_txt">名称：</div>
                                <div class="form_input">
                                    <input type="text" name="title" size="50" maxlength="20" class="ip" value="<?php echo ($info["title"]); ?>" data-rule="名称:required;" >
                                </div>
                            </div>
                            <div class="form_group">
                            ...
                            <div class="form_group" id="modetype">
                                <div class="form_txt">链接类型：</div>
                                <div class="form_input">
                                    <label class="line-height-1 blue">
                                        <input name="type" value="0" type="radio" class="ace" <?php if(($info['type'] == '0') or ($info['type'] == '')): ?>checked<?php endif; ?>>
                                    ...
                                    <div class="form_input" style="width:200px">
                                        <select name="category_id" class="ip beautify_input">
                                            <?php if(is_array($category_list)): $i = 0; $__LIST__ = $category_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><option value="<?php echo ($v["id"]); ?>" <?php if(($info['type'] == 1) and ($v['id'] == $info['item_id'])): ?>selected<?php endif; ?>>
                                                <?php $__FOR_START_86641664__=1;$__FOR_END_86641664__=$v['level'];for($i=$__FOR_START_86641664__;$i < $__FOR_END_86641664__;$i+=1){ ?>&nbsp;&nbsp;&nbsp;&nbsp;<?php } echo ($v["catename"]); ?>
...
<script src="/Public/Admin/js/main.js"></script>
    ...
    <script>
        ...
        $(".formname").MotorsSubmit({
            ajaxurl:"<?php echo U('Slide/listadd');?>",
            loadurl:"<?php echo U('Slide/listpage',array('classid'=>$classid));?>"
        });
    </script>
