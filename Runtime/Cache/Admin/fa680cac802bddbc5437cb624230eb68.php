...
<link rel="stylesheet" href="/Public/Admin/css/main.css?version=<?php echo (VERSION); ?>" />
    ...
    <link rel="stylesheet" type="text/css" href="/Public/Admin/css/weixin.css">
...
<div class="main-container" id="main-container">
    ...
    <div class="breadcrumbs" id="breadcrumbs">
        <ul class="breadcrumb">
            ...
            <li><span><?php if(!empty($info["id"])): ?>编辑<?php else: ?>添加<?php endif; ?>菜单</span></li>
        </ul><!-- /.breadcrumb -->
    </div>
                        ...
                        <form class="form-horizontal keywordForm" method="post">
                            ...
                            <div class="form_group">
                                ...
                                <div class="form_input">
                                    <input type="text" class="ip" size="50" name="title" value="<?php echo ($info["title"]); ?>" data-rule="菜单名称:required;"/>
                                </div>
                            </div>
                            <div class="form_group">
                                ...
                                <div class="form_input" style="width:200px;">
                                    <select name="pid" class="ip beautify_input">
                                        <?php if(!empty($categoryInfo)): ?><option value="<?php echo ($categoryInfo["id"]); ?>"><?php echo ($categoryInfo["title"]); ?></option>
                                        <?php else: ?>
                                            <option value="0">作为一级菜单</option>
                                            <?php if(is_array($category)): $i = 0; $__LIST__ = $category;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><option value="<?php echo ($v["id"]); ?>" <?php if(($v["id"]) == $info['pid']): ?>selected<?php endif; ?>><?php echo ($v["title"]); ?></option><?php endforeach; endif; else: echo "" ;endif; endif; ?>
                                    </select>
                            ...
                            <div class="form_group">
                                ...
                                <div class="form_input" style="width:200px;">
                                    <select name="type" class="ip beautify_input" id="reply_type">
                                        <option value="" <?php if(empty($info)): ?>selected<?php endif; ?>>请选择回复类型</option>
                                        <option value="1" <?php if(($info["type"]) == "1"): ?>selected<?php endif; ?>>文本回复</option>
                                        <option value="2" <?php if(($info["type"]) == "2"): ?>selected<?php endif; ?>>图文回复</option>
                                        <option value="3" <?php if(($info["type"]) == "3"): ?>selected<?php endif; ?>>外链</option>
                                    </select>

                                </div>
                            </div>
                            <div class="form_group" id="reply_content" <?php if(($info["type"]) != "1"): ?>style="display: none"<?php endif; ?>>
                                <div class="form_txt">回复内容：</div>
                                <div class="form_input">
                                    <textarea name="content" rows="5" cols="50"><?php echo ($materInfo["content"]); ?></textarea>
                                </div>
                            </div>
                            <div class="form_group" id="reply_id" <?php if(($info["type"]) != "2"): ?>style="display: none"<?php endif; ?>>
                                ...
                                <div class="form_input">
                                    ...
                                    <input type="hidden" name="mater_id" id="mater_id" size="50" value="<?php echo ($materInfo["id"]); ?>">
                                    <div class="master_box">
                                        <?php if(!empty($materInfo)): ?><div class="list-loop">
    <div class="info">
    ...
    <?php if(is_array($materInfo["newslist"])): $i = 0; $__LIST__ = $materInfo["newslist"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vn): $mod = ($i % 2 );++$i; if(($key) == "0"): ?><div class="hover">
            ...
            <div class="item">
                ...
                <a href="javascript:;"><?php echo ($vn["title"]); ?></a>
                            ...
                            <div class="form_group" id="replay_url" <?php if(($info["type"]) != "3"): ?>style="display: none"<?php endif; ?>>
                                <div class="form_txt">链接网址：</div>
                                <div class="form_input">
                                    <input type="text" class="ip" size="50" name="url" value="<?php echo ($info["url"]); ?>" data-rule="链接网址:url;"/>
                                </div>
                            </div>
                            <div class="form_group">
                                <div class="form_txt">排序：</div>
                                <div class="form_input">
                                    <input type="text" class="ip" size="50" name="sort" value="<?php echo ($info["sort"]); ?>"/>
                                    <span>数字越小越靠前</span>
                                </div>
                            </div>
                            <div class="form_group">
                                ...
                                <div class="form_input">
                                    <label class="checklabel">
                                        <input name="is_show" type="radio" class="ace" value="1" <?php if(($info["is_show"]) != "0"): ?>checked<?php endif; ?>>
                                        <span class="lbl"> 是</span>
                                    </label>
                                    <label class="checklabel">
                                        <input name="is_show" type="radio" class="ace" value="0" <?php if(($info["is_show"]) == "0"): ?>checked<?php endif; ?>>
                            ...
                            <div class="form_group">
                                <div class="form_bnt">
                                    ...
                                    <a href="<?php echo U('Weixin/menu');?>" class="btn btn-white btn-warning btn-round">
...
<script src="/Public/Admin/js/main.js"></script>
    ...
    <script src="/Public/Admin/js/weixin.js"></script>
    <script>
        /**
         * 保存
         */
        $(".keywordForm").MotorsSubmit({
            ajaxurl:"<?php echo U('Weixin/menuAdd');?>",
            loadurl:"<?php echo U('Weixin/menu');?>"
        });
    </script>
