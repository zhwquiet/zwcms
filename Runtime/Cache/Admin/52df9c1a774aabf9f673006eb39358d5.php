...
<div class="main-container" id="main-container">
    ...
    <div class="page-content">
        ...
        <div class="page-content-area">
            ...
            <div class="row">
                <div class="col-xs-12">
                    <?php if(empty($groupid)): ?><div class="nav_menu">
                            <ul>
                                <li><a href="<?php echo U('System/addAdmin');?>"><span class="icon iconfont icon-liebiaoshouqi"></span>添加管理员</a></li>
                            </ul>
                        </div><?php endif; ?>
                    <div id="tablelist">
                        <table class="table table-striped table-bordered table-hover">
                            ...
                            <?php if(is_array($adminList)): foreach($adminList as $key=>$vo): ?><tr>
                                    ...
                                    <td align="center"><?php echo ($vo["logincount"]); ?></td>
                                    <td align="center"><?php echo (date("Y-m-d H:i:s", $vo["lastlogintime"])); ?></td>
                                    <td align="center"><?php echo ($vo["lastloginip"]); ?></td>
                                    <td align="center"><?php echo ($vo["groupname"]); ?></td>
                                    <td align="center"><?php if($vo['islock'] == 0): ?>锁定<?php else: ?>正常<?php endif; ?></td>
                                    <td align="center">
                                        <a href="<?php echo U('System/addAdmin',array('id'=>$vo['id']));?>">编辑</a>
                                        <?php if(($vo["id"]) != "1"): ?><a href="javascript:;" class="delete" rel="<?php echo U('System/delAdmin',array('id'=>$vo['id']));?>">删除</a><?php endif; ?>
                                    </td>
