...
<div class="main-container" id="main-container">
    ...
    <div class="breadcrumbs" id="breadcrumbs">
        <ul class="breadcrumb">
            ...
            <li><a href="<?php echo U('Nav/classindex');?>"><?php echo ($classtitle); ?></a></li>
            <li><a href="<?php echo U('Nav/index',array('classid'=>$classid));?>">菜单管理</a></li>
            <li>添加菜单</li>
        </ul><!-- /.breadcrumb -->
                        ...
                        <form class="formname" method="post">
                            ...
                            <div class="form_group">
                                ...
                                <div class="form_input">
                                    <input type="text" name="title" size="50" maxlength="20" class="ip" value="<?php echo ($info["title"]); ?>" data-rule="菜单名称:required;" >
                                </div>
                            </div>
                            ...
                            <div class="form_group">
                                ...
                                <div class="form_input" style="width:200px">
                                    <select name="pid" class="ip beautify_input">
                                        ...
                                        <?php if(is_array($plist)): $i = 0; $__LIST__ = $plist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><option value="<?php echo ($v["id"]); ?>" <?php if(($v["id"]) == $pid): ?>selected<?php endif; ?>><?php echo ($v["title"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                    </select>
                                </div>
                            </div>
                            <div class="form_group">
                                ...
                                <div class="form_input">
                                    <input type="text" size="50" maxlength="255" class="ip" value="<?php echo (getattachurl($info["picid"])); ?>" disabled/>
                                    <input type="hidden" name="picid" value="<?php echo ($info["picid"]); ?>"/>
                                ...
                                <div class="form_input img-div" style="display:none;">
                                    <img src="<?php echo (getattachurl($info["picid"])); ?>">
                            ...
                            <div class="form_group" id="modetype">
                                ...
                                <div class="form_input">
                                    <label class="line-height-1 blue">
                                        <input name="type" value="1" type="radio" class="ace" <?php if(($info["type"]) == "1"): ?>checked<?php endif; ?>>
                                        <span class="lbl">栏目</span>
                                    </label>
                                    <label class="line-height-1 blue">
                                        <input name="type" value="2" type="radio" class="ace" <?php if(($info["type"]) == "2"): ?>checked<?php endif; ?>>
                                        <span class="lbl">内容</span>
                                    </label>
                                    <label class="line-height-1 blue">
                                        <input name="type" value="3" type="radio" class="ace" <?php if(($info["type"]) == "3"): ?>checked<?php endif; ?>>
                                        <span class="lbl">外链</span>
                                    </label>
                                </div>
                            </div>
                            <div class="typeshow">
                                <div class="form_group type1" <?php if(($info["type"]) != "1"): ?>style="display:none;"<?php endif; ?>>
                                    <div class="form_txt">选择栏目：</div>
                                    <div class="form_input" style="width:200px">
                                        <select name="category_id" class="ip beautify_input">
                                            <?php if(is_array($category_list)): $i = 0; $__LIST__ = $category_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><option value="<?php echo ($v["id"]); ?>" <?php if(($info['type'] == 1) and ($v['id'] == $info['item_id'])): ?>selected<?php endif; ?>>
                                                <?php $__FOR_START_1800368664__=1;$__FOR_END_1800368664__=$v['level'];for($i=$__FOR_START_1800368664__;$i < $__FOR_END_1800368664__;$i+=1){ ?>&nbsp;&nbsp;&nbsp;&nbsp;<?php } echo ($v["catename"]); ?>
                                                </option><?php endforeach; endif; else: echo "" ;endif; ?>
                                        </select>
                                    </div>
                                </div>
                                <div class="form_group type2" <?php if(($info["type"]) != "2"): ?>style="display:none;"<?php endif; ?>>
                                    <div class="form_txt">选择内容：</div>
                                    <div class="form_input" style="width:200px">
                                        <select name="content_id" class="ip beautify_input">
                                            <?php if(is_array($content_list)): $i = 0; $__LIST__ = $content_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><option value="<?php echo ($v["id"]); ?>" <?php if(($info['type'] == 2) and ($v['id'] == $info['item_id'])): ?>selected<?php endif; ?>>
                                                <?php echo ($v["title"]); ?>
                                                </option><?php endforeach; endif; else: echo "" ;endif; ?>
                                        </select>
                                    </div>
                                </div>
                                <div class="form_group type3" <?php if(($info["type"]) != "3"): ?>style="display:none;"<?php endif; ?>>
                                    <div class="form_txt">链接地址：</div>
                                    <div class="form_input">
                                        <input type="text" name="url" size="50" maxlength="50" class="ip" value="<?php echo ($info["url"]); ?>" data-rule="外链地址:url;" >
                            ...
                            <div class="form_group">
                                ...
                                <div class="form_input">
                                    <input type="text" name="ordnum" size="30" maxlength="20" class="ip" value="<?php echo ((isset($info["ordnum"]) && ($info["ordnum"] !== ""))?($info["ordnum"]):0); ?>" onkeyup="checkInt(this)"/>
                                </div>
                            </div>
                            <div class="form_group">
                                ...
                                <div class="form_input">
                                    <label class="line-height-1 blue">
                                        <input name="mode" value="1" type="radio" class="ace" <?php if(($info["mode"]) != "2"): ?>checked<?php endif; ?>>
                                        <span class="lbl">默认方式</span>
                                    </label>
                                    <label class="line-height-1 blue">
                                        <input name="mode" value="2" type="radio" class="ace" <?php if(($info["mode"]) == "2"): ?>checked<?php endif; ?>>
                            ...
                            <div class="form_group">
                                ...
                                <div class="form_input">
                                    <label class="line-height-1 blue">
                                        <input name="isshow" value="1" type="radio" class="ace" <?php if(($info["isshow"]) != "0"): ?>checked<?php endif; ?>>
...
<script src="/Public/Admin/js/main.js"></script>
    ...
    <script>
        ...
        $(".formname").MotorsSubmit({
            ajaxurl:"<?php echo U('Nav/add');?>",
            loadurl:"<?php echo U('Nav/index',array('classid'=>$classid));?>"
        });
    </script>
