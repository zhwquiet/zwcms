                    ...
                    <div class="table_form">
                        <form class="form-horizontal formname" method="post">
                            <div class="form_group">
                                ...
                                <div class="form_input"><input type="text" name="upmaxsize" size="50" maxlength="9" class="ip" value="<?php echo ($uploadInfo["upmaxsize"]); ?>" data-rule="大小限制:required;digits" /><span>单位KB</span></div>
                            </div>
                            <div class="form_group">
                                <div class="form_txt">图片文件类型：</div>
                                <div class="form_input">
                                    <input type="text" name="uptype_pic" size="50" maxlength="255" class="ip" value="<?php echo ($uploadInfo["uptype_pic"]); ?>" data-rule="图片文件类型:required;" /><span>格式：gif|jpg|png</span>
                                </div>
                            </div>
                            <div class="form_group">
                                <div class="form_txt">视频文件类型：</div>
                                <div class="form_input"><input type="text" name="uptype_video" size="50" maxlength="255" class="ip" value="<?php echo ($uploadInfo["uptype_video"]); ?>" data-rule="视频文件类型:required;" /><span>格式：swf|flv</span></div>
                            </div>
                            <div class="form_group">
                                <div class="form_txt">附件文件类型：</div>
                                <div class="form_input"><input type="text" name="uptype_file" size="50" maxlength="255" class="ip" value="<?php echo ($uploadInfo["uptype_file"]); ?>" data-rule="附件文件类型:required;" /><span>格式：rar|zip</span></div>
                            </div>
                            <div class="form_group">
                                <div class="form_bnt">
...
<script src="/Public/Admin/js/main.js"></script>
    ...
    <script>
        $(".formname").MotorsSubmit({
            ajaxurl:"<?php echo U('Setting/uploadSetting');?>"
        });
    </script>
