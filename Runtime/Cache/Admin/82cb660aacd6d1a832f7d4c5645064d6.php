            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="table_form">
                        <form class="form-horizontal concernForm" method="post">
                            <input type="hidden" name="id" value="<?php echo ($info["id"]); ?>" />
                            <div class="form_group">
                                <div class="form_txt">是否启用：</div>
                                <div class="form_input" style="width:200px;">
                                    <select name="type" class="ip beautify_input" id="reply_type">
                                        <option value="0" <?php if(empty($info) or $info['type'] == 0): ?>selected<?php endif; ?>>关闭</option>
...
<script src="/Public/Admin/js/main.js"></script>
    ...
    <script>
         ...
         * 保存
         */
        $(".concernForm").MotorsSubmit({
            ajaxurl:"<?php echo U('Weixin/concern');?>",
            isreload:true
        });
    </script>
