			...
			<div class="row">
				<div class="col-xs-12">
					<div class="nav_menu">
						<ul>
							<li>
								<a href="<?php echo U('Model/addItem');?>">
									<span class="icon iconfont icon-liebiaoshouqi"></span>添加模型
								</a>
							</li>
						</ul>
					</div>
					<div id="tablelist">
						<table class="table table-striped table-bordered table-hover">
							<thead>
							<tr class="head_nav">
								<td style="width: 66px;"><a>ID</a></td>
								<td style="width: 360px"><a>模型名称</a></td>
								<td style="width: 70px"><a>数据表</a></td>
								<td style="width: 70px"><a>描述</a></td>
								<td style="width: 70px"><a>状态</a></td>
								<td>管理</td>
							</tr>
							</thead>
							<tbody>
							<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr class="item" attr_id="<?php echo ($v["id"]); ?>">
									<td><?php echo ($v["id"]); ?></td>
									<td><?php echo ($v["modelname"]); ?></td>
									<td><?php echo ($v["tablename"]); ?></td>
									<td>
										<?php echo ($v["modeldesc"]); ?>
									</td>
									<td>
										正常
									</td>
									<td class="edit">
										<a href="<?php echo U('Model/field',array('id'=>$v['id']));?>">自定义字段</a>
										<a href="<?php echo U('Model/updateItem',array('id'=>$v['id']));?>">编辑</a>
										<?php if(($v['islock']) != "1"): ?><a class="delete" rel="<?php echo U('Model/deleteItem',array('id'=>$v['id']));?>">删除</a><?php endif; ?>
									</td>
