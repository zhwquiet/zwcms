            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="nav_menu">
                        <ul>
                            <li class="dropdown">
                                <a href="<?php echo U('Category/addItem',array('flag'=>1));?>">
                                    <span class="icon iconfont icon-xingzhuang"></span>添加栏目
                                </a>
                                <dl>
                                    <dt><a href="<?php echo U('Category/addItem',array('flag'=>1));?>">添加栏目</a></dt>
                                    <dt><a href="<?php echo U('Category/addItem',array('flag'=>-1));?>">添加单网页</a></dt>
                                </dl>
                            </li>
                    ...
                    <div id="tablelist">
                        ...
                        <tbody>
                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr class="item item<?php echo ($v["id"]); ?> child-tr child<?php echo ($v["pid"]); ?>" data-id="<?php echo ($v["id"]); ?>" data-pid="<?php echo ($v["pid"]); ?>">
                            <td style="width: 200px;text-align: left;">
                                <?php $__FOR_START_1809067270__=1;$__FOR_END_1809067270__=$v['level'];for($i=$__FOR_START_1809067270__;$i < $__FOR_END_1809067270__;$i+=1){ ?>&nbsp;&nbsp;&nbsp;&nbsp;<?php } ?>
                                <?php if(!empty($v["sonid"])): ?><i class="tree-icon iconfont icon-liebiaozhankai"></i>
                                <?php else: ?>
                                    <i class="tree-icon iconfont icon-zixunlanmu"></i><?php endif; ?>
                                <?php echo ($v["catename"]); ?>
                            </td>
                            <td><?php echo ($v["id"]); ?></td>
                            <td><input class="ord_input" type="text" value="<?php echo ($v["ordnum"]); ?>" maxlength="9" onkeyup="checkInt(this)"></td>
                            <td>
                                <?php if($v['modelid'] == -1): ?><a style="color: blue">单网页</a>
                                    <?php elseif($v['modelid'] == -2): ?>
                            ...
                            <td class="edit">
                                <a href="<?php echo U('Category/addItem',array('pid'=>$v['id']));?>">添加子栏目</a>
                                <?php if(($v["modelid"]) != "-2"): ?><a href="<?php echo U('Category/content',array('cateid'=>$v['id']));?>">内容管理</a><?php endif; ?>
                                <a class="moveItem" data-id="<?php echo ($v["id"]); ?>">移动</a>
                                <a href="<?php echo U('Category/addItem',array('id'=>$v['id']));?>">编辑</a>
                                <a class="deleteItemBtn">删除</a>
                            </td>
                            </tr><?php endforeach; endif; else: echo "" ;endif; ?>
                        <tr class="table_bottom">
                            <td colspan="6">
                                <a class="save_btn_sort" data-url="<?php echo U('Category/reSort');?>">保存排序</a>
                            </td>
                        </tr>
                        </tbody>
                    </table>
