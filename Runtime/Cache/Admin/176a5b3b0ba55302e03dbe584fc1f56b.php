            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="nav_menu">
                        <ul>
                            <li>
                                <a href="<?php echo U('Slide/add');?>">
                                    <span class="icon iconfont icon-liebiaoshouqi"></span>添加幻灯片
                                </a>
                            </li>
                        </ul>
                    </div>
                    <div id="tablelist">
                        <table class="table table-striped table-bordered table-hover">
                            ...
                            <tbody>
                            <?php if(!empty($list)): if(is_array($list)): $key = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($key % 2 );++$key;?><tr class="item" attr_id="<?php echo ($v["id"]); ?>">
                                        <td><?php echo ($key); ?></td>
                                        <td><?php echo ($v["title"]); ?></td>
                                        <td><?php echo ($v["name"]); ?></td>
                                        <td class="edit">
                                            <a href="<?php echo U('Slide/listpage',array('classid'=>$v['id']));?>">列表管理</a>
                                            <a href="<?php echo U('Slide/add',array('id'=>$v['id']));?>">编辑</a>
                                            <?php if(($v['islock']) != "1"): ?><a class="delete" rel="<?php echo U('Slide/del',array('id'=>$v['id']));?>">删除</a><?php endif; ?>
                                        </td>
                                    </tr><?php endforeach; endif; else: echo "" ;endif; ?>
                                <?php else: ?>
                                <tr>
                                    <td colspan="4">暂无导航</td>
                                </tr><?php endif; ?>
                            </tbody>
                        </table>
                    </div>
