        ...
        <div class="page-content-area">
            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="nav_menu">
                        <ul>
                            <li><a href="<?php echo U('System/addGroup');?>"><span class="icon iconfont icon-liebiaoshouqi"></span>添加角色</a></li>
                        </ul>
                    </div>
                    <div id="tablelist">
                        <table class="table table-striped table-bordered table-hover">
                            ...
                            <tbody>
                            <?php if(is_array($groupInfo)): foreach($groupInfo as $key=>$vo): ?><tr>
                                    <td align="center"><?php echo ($vo["id"]); ?></td>
                                    <td><?php echo ($vo["groupname"]); ?></td>
                                    <td><?php echo ($vo["groupdesc"]); ?></td>
                                    <td align="center"><?php echo (date("Y-m-d H:i:s", $vo["createdate"])); ?></td>
                                    <td align="center">
                                        <a href="<?php echo U('System/pageConfig',array('id'=>$vo['id']));?>">页面权限</a>
                                        <!-- <a href="?act=editcate&id=<?php echo ($rs[id]); ?>">栏目权限</a> -->
                                        <a href="<?php echo U('System/adminList',array('groupid'=>$vo['id']));?>">成员管理</a>
                                        <a href="<?php echo U('System/addGroup',array('id'=>$vo['id']));?>">编辑</a>
                                        <?php if(($vo["id"]) != "1"): ?><a href="javascript:void(0);" class="delete" rel="<?php echo U('System/delGroup',array('id'=>$vo['id']));?>">删除</a><?php endif; ?>
                                    </td>
