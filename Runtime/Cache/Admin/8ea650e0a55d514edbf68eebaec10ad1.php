...
<div class="main-container" id="main-container">
    ...
    <div class="breadcrumbs" id="breadcrumbs">
        <ul class="breadcrumb">
            ...
            <li>
                <a href="<?php echo U('Nav/classindex');?>"><?php echo ($classtitle); ?></a>
            </li>
            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="nav_menu">
                        <ul>
                            <li>
                                <a href="<?php echo U('Nav/add',array('classid'=>$classid));?>">
                                    <span class="iconfont">&#xe618;</span>添加菜单
                                </a>
                            </li>
                        </ul>
                    </div>
                        ...
                        <table class="table table-striped table-bordered table-hover">
                            ...
                            <?php if(!empty($list)): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr class="item item<?php echo ($v["id"]); ?> child-tr child<?php echo ($v["pid"]); ?>" data-id="<?php echo ($v["id"]); ?>" data-pid="<?php echo ($v["pid"]); ?>">
                                    <td style="width: 200px;text-align: left;">
                                        <?php $__FOR_START_881214103__=1;$__FOR_END_881214103__=$v['level'];for($i=$__FOR_START_881214103__;$i < $__FOR_END_881214103__;$i+=1){ ?>&nbsp;&nbsp;&nbsp;&nbsp;<?php } ?>
                                    ...
                                    <td class="edit">
                                        <?php if(($v["pid"]) == "0"): ?><a href="<?php echo U('Nav/add',array('pid'=>$v['id'],'classid'=>$classid));?>">添加子菜单</a><?php endif; ?>

                                        <a href="<?php echo U('Nav/add',array('id'=>$v['id']));?>">编辑</a>
                                        <a class="delete" rel="<?php echo U('Nav/del',array('id'=>$v['id']));?>">删除</a>
                                    </td>
                                </tr><?php endforeach; endif; else: echo "" ;endif; ?>
                            <tr class="table_bottom">
                                <td colspan="6">
                                    <a class="save_btn_sort" data-url="<?php echo U('Nav/reSort');?>">保存排序</a>
                                </td>
                            </tr>
                            <?php else: ?>
                                <tr>
