...
<div class="main-container" id="main-container">
    ...
    <div class="breadcrumbs" id="breadcrumbs">
        <ul class="breadcrumb">
            ...
            <li><a href="<?php echo U('Weixin/keywords',array('isprevpage'=>1));?>">关键词回复</a></li>
            <li><span><?php if(!empty($info["id"])): ?>编辑<?php else: ?>添加<?php endif; ?>关键词</span></li>
        </ul><!-- /.breadcrumb -->
    </div>
                    ...
                    <div class="table_form">
                        <form class="form-horizontal keywordForm" method="post">
                            ...
                            <div class="form_group">
                                <div class="form_txt">关键词名称：</div>
                                <div class="form_input">
                                    <input type="text" class="ip" size="50" name="keyword" value="<?php echo ($info["keyword"]); ?>" data-rule="关键词名称:required;"/>
                                </div>
                            </div>
                            <div class="form_group">
                                <div class="form_txt">回复类型：</div>
                                <div class="form_input" style="width:200px;">
                                    <select name="type" class="ip beautify_input" id="reply_type">
                                        <option value="0" <?php if(empty($info) or $info['type'] == 0): ?>selected<?php endif; ?>>请选择回复类型</option>
                            ...
                            <div class="form_group" id="reply_content" <?php if(($info["type"]) != "1"): ?>style="display: none"<?php endif; ?>>
                                ...
                                <div class="form_input">
                                    <textarea name="content" rows="5" cols="50"><?php echo ($info["content"]); ?></textarea>
                                </div>
                            </div>
    ...
    <?php if(is_array($materInfo["newslist"])): $i = 0; $__LIST__ = $materInfo["newslist"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vn): $mod = ($i % 2 );++$i; if(($key) == "0"): ?><div class="hover">
            ...
            <div class="item">
                ...
                <a href="javascript:;"><?php echo ($vn["title"]); ?></a>
                            ...
                            <div class="form_group">
                                <div class="form_txt">匹配方式：</div>
                                <div class="form_input">
                                    <label class="checklabel">
                                        <input name="method_type" type="radio" class="ace" value="1" <?php if(($info["method_type"]) != "2"): ?>checked<?php endif; ?>>
                                        <span class="lbl"> 完全匹配</span>
                                    </label>
                                    <label class="checklabel">
                                        <input name="method_type" type="radio" class="ace" value="2" <?php if(($info["method_type"]) == "2"): ?>checked<?php endif; ?>>
                            ...
                            <div class="form_group">
                                ...
                                <div class="form_input">
                                    <label class="checklabel">
                                        <input name="status" type="radio" class="ace" value="1" <?php if(($info["status"]) != "0"): ?>checked<?php endif; ?>>
                                        <span class="lbl"> 启用</span>
                                    </label>
                                    <label class="checklabel">
                                        <input name="status" type="radio" class="ace" value="0" <?php if(($info["status"]) == "0"): ?>checked<?php endif; ?>>
                            ...
                            <div class="form_group">
                                <div class="form_bnt">
                                    ...
                                    <a href="<?php echo U('Weixin/keywords',array('isprevpage'=>1));?>" class="btn btn-white btn-warning btn-round">
...
<script src="/Public/Admin/js/main.js"></script>
    ...
    <script>
        ...
        if(infoId){
            var loadurl = "<?php echo U('Weixin/keywords',array('isprevpage'=>1));?>";
        }else{
            var loadurl = "<?php echo U('Weixin/keywords');?>";
        }
        $(".keywordForm").MotorsSubmit({
            ajaxurl:"<?php echo U('Weixin/keywordsAdd');?>",
            loadurl:loadurl
        });
    </script>
