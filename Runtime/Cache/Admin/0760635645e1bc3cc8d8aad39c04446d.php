...
<div class="main-container" id="main-container">
	...
	<ul class="nav nav-list">
		...
		<a href="<?php if(!empty($v["url"])): ?>/admin.php/<?php echo ($v["url"]); else: ?>#<?php endif; ?>" <?php if(empty($v["url"])): ?>class="dropdown-toggle"<?php endif; ?>>
		...
		<?php if(!empty($v["child"])): ?><ul class="submenu">
			...
			<a href="/admin.php/<?php echo ($v1["url"]); ?>">
    ...
    <div class="breadcrumbs" id="breadcrumbs">
        <ul class="breadcrumb">
            ...
            <li><a href="<?php echo U('System/adminList');?>">管理员管理</a></li>
            <li>
                编辑
            </li>
        </ul><!-- /.breadcrumb -->
                        ...
                        <form class="form-horizontal formname" method="post">
                            <div class="form_group">
                                ...
                                <div class="form_input">
                                    <input type="text" name="adminname" size="30" maxlength="20" class="ip" value="<?php echo ($adminInfo["adminname"]); ?>" disabled="disabled" /><span>不可修改</span></div>
                            ...
                            <div class="form_group">
                                ...
                                <input type="hidden" name="oldPassword" value="<?php echo ($adminInfo["password"]); ?>">
                            </div>
                            <div class="form_group">
                                <div class="form_txt">笔名：</div>
                                <div class="form_input"><input type="text" name="penname" size="30" maxlength="20" class="ip" value="<?php echo ($adminInfo["penname"]); ?>" data-rule="笔名:required;" /><span>用于发布内容处的作者</span></div>
                            </div>
                            <div class="form_group">
                                <div class="form_txt">状态：</div>
                                <div class="form_input"><input type="radio" name="islock" value="0" id="t2_0" <?php if($adminInfo['islock'] == 0): ?>checked<?php endif; ?>  /><label for="t2_0">锁定</label><input type="radio" name="islock" value="1" id="t2_1" <?php if($adminInfo['islock'] == 1): ?>checked<?php endif; ?>/><label for="t2_1">正常</label></div>
                            </div>
                            <div class="form_group">
                                <div class="form_txt">所属角色：</div>
                                <div class="form_input clear" style="width:200px;">
                                    <select name="groupid" class="ip beautify_input" data-rule="所属角色:required;">
                                        <option value="">请选择</option>
                                        <?php if(is_array($groupInfo)): foreach($groupInfo as $key=>$vo): ?><option value="<?php echo ($vo["id"]); ?>" <?php if(($vo["id"]) == $adminInfo["groupid"]): ?>selected<?php endif; ?>><?php echo ($vo["groupname"]); ?></option><?php endforeach; endif; ?>
                                    </select>
                                </div>
                            </div>
                            <div class="form_group">
                                <div class="form_bnt">
                                    ...
                                    <a href="<?php echo U('System/adminList');?>" class="btn btn-white btn-warning btn-round">
...
<script src="/Public/Admin/js/main.js"></script>
    ...
    <script>
        $(".formname").MotorsSubmit({
            ajaxurl:"<?php echo U('System/editAdmin');?>",
            loadurl:"<?php echo U('System/adminList');?>"
        });
    </script>
