			...
			<div class="row">
				<div class="col-xs-12">
					<div class="table_form">
						<form class="form-horizontal formname" method="post" target="html">
							<div class="form_group">
								<div class="form_txt">生成首页</div>
							</div>
							<div class="form_group">
								<div class="form_bnt">
									<button class="btn btn-white btn-info btn-round" id="createindex" type="button">
										<i class="ace-icon fa fa-floppy-o bigger-120 blue"></i> 开始生成
									</button>
								</div>
							</div>
						</form>
