...
<div class="main-container" id="main-container">
    ...
    <div class="breadcrumbs" id="breadcrumbs">
        <ul class="breadcrumb">
            ...
            <li><a href="<?php echo U('Nav/classindex');?>">导航管理</a></li>
            <li>添加导航</li>
        </ul><!-- /.breadcrumb -->
                        ...
                        <form class="formname" method="post">
                            ...
                            <div class="form_group">
                                ...
                                <div class="form_input">
                                    ...
                                    <?php else: ?>
                                        <input type="text" name="name" size="50" maxlength="20" class="ip" value="<?php echo ($info["name"]); ?>" data-rule="导航名称:required;letters;" /><span>只能为字母，保存后不能更改</span><?php endif; ?>
                                </div>
                            </div>
                            <div class="form_group">
                                <div class="form_txt">导航标题：</div>
                                <div class="form_input">
                                    <input type="text" name="title" size="50" maxlength="20" class="ip" value="<?php echo ($info["title"]); ?>" data-rule="导航标题:required;" ></div>
                            </div>
                            <div class="form_group">
                                <div class="form_bnt">
...
<script src="../Public/Admin/js/main.js"></script>
    ...
    <script>
        $(".formname").MotorsSubmit({
            ajaxurl:"<?php echo U('Nav/classadd');?>",
            loadurl:"<?php echo U('Nav/classindex');?>"
        });
    </script>
