...
<div class="main-container" id="main-container">
    ...
    <div class="breadcrumbs" id="breadcrumbs">
        <ul class="breadcrumb">
            ...
            <li><a href="<?php echo U('Comment/Index',array('isprevpage'=>1));?>">评论管理</a></li>
            <li>
                评论配置
            </li>
        </ul><!-- /.breadcrumb -->
                    ...
                    <div class="table_form">
                        <form class="form-horizontal formname" method="post">
                            <div class="form_group">
                                <div class="form_txt">评论开关：</div>
                                <div class="form_input">
                                    <label class="checklabel">
                                        <input name="comOpen" type="radio" class="ace" value="1" <?php if($comConfig['commentopen'] == 1): ?>checked<?php endif; ?>>
                                        <span class="lbl"> 开启</span>
                                    </label>
                                    <label class="checklabel">
                                        <input name="comOpen" type="radio" class="ace" value="0" <?php if($comConfig['commentopen'] == 0): ?>checked<?php endif; ?>>
                                        <span class="lbl"> 关闭</span>
                                    </label>
                                </div>
                            </div>
                            <div class="form_group">
                                <div class="form_txt">评论审核：</div>
                                <div class="form_input">
                                    <label class="checklabel">
                                        <input name="comCheck" type="radio" class="ace" value="1" <?php if($comConfig['commentcheck'] == 1): ?>checked<?php endif; ?>>
                                        <span class="lbl"> 开启</span>
                                    </label>
                                    <label class="checklabel">
                                        <input name="comCheck" type="radio" class="ace" value="0" <?php if($comConfig['commentcheck'] == 0): ?>checked<?php endif; ?>>
                                        <span class="lbl"> 关闭</span>
                                    </label>
                                </div>
                            </div>
                            <div class="form_group">
                                <div class="form_bnt">
                                    ...
                                    <a href="<?php echo U('Comment/Index',array('isprevpage'=>1));?>" class="btn btn-white btn-warning btn-round">
...
<script src="/Public/Admin/js/main.js"></script>
    ...
    <script>
        $(".formname").MotorsSubmit({
            ajaxurl:"<?php echo U('Comment/comConfig');?>"
        });
    </script>
