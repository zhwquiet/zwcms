...
<div class="main-container" id="main-container">
    ...
    <div class="breadcrumbs" id="breadcrumbs">
        <ul class="breadcrumb">
            ...
            <li><a href="<?php echo U('Expand/linkClass',array('isprevpage'=>1));?>">类别管理</a></li>
            <li>
                <?php if(!empty($oneCate)): ?>编辑<?php else: ?>添加<?php endif; ?>
            </li>
        </ul><!-- /.breadcrumb -->
                ...
                <div class="col-xs-12">
                    <div class="table_form">
                        <form class="formname" method="post">
                            <input type="hidden" name="classid" value="<?php echo ($oneCate["classid"]); ?>"/>
                            <div class="form_group">
                                <div class="form_txt">类别名称：</div>
                                <div class="form_input"><input type="text" name="classname" value="<?php echo ($oneCate["classname"]); ?>" size="30" maxlength="30" class="ip" data-rule="类别名称:required;className;" /></div>
                            </div>
                            <div class="form_group">
                                <div class="form_txt">类别排序：</div>
                                <div class="form_input"><input type="text" name="ordnum" value="<?php echo ($oneCate["ordnum"]); ?>" size="30" <?php if(!empty($oneCate)): ?>value="<?php echo ($oneCate["ordnum"]); ?>"<?php endif; ?> maxlength="4" class="ip" data-rule="类别排序:digits;"/>　<span>不填写则为0</span></div>
                            </div>
                            <div class="form_group">
                                <div class="form_bnt">
                                    ...
                                    <a href="<?php echo U('Expand/linkClass',array('isprevpage'=>1));?>" class="btn btn-white btn-warning btn-round">
...
<script src="/Public/Admin/js/main.js"></script>
    ...
    <script>
        var infoId = "<?php echo ($oneCate["classid"]); ?>";
        if(infoId){
            var loadurl = "<?php echo U('Expand/linkClass',array('isprevpage'=>1));?>";
        }else{
            var loadurl = "<?php echo U('Expand/linkClass');?>";
        }
        $(".formname").MotorsSubmit({
            ajaxurl:"<?php echo U('Expand/classAddAjax');?>",
            loadurl:loadurl
        });
    </script>
