                    ...
                    <div class="table_form">
                        <form class="form-horizontal formname" method="post">
                            <div class="form_group">
                                ...
                                <div class="form_input"><textarea name="seotitle" cols="60" rows="4" onKeyUp="strlen_verify(this,'title_len',255)" class="tt"><?php echo ($seoInfo["seotitle"]); ?></textarea>　还可输入<span id="title_len"><?php echo (strlength($seoInfo["seotitle"],255)); ?></span> 个字符　<br><span>附加在HTML源码的title标签内的文字</span></div>
                            </div>
                            <div class="form_group">
                                <div class="form_txt">站点关键字：</div>
                                <div class="form_input"><textarea name="seokey" cols="60" rows="4" onKeyUp="strlen_verify(this,'key_len',255)" class="tt"><?php echo ($seoInfo["seokey"]); ?></textarea>　还可输入<span id="key_len"><?php echo (strlength($seoInfo["seokey"],255)); ?></span> 个字符　<br><span>META标签的keywords内容. 关键字之间使用 "," 分隔</span></div>
                            </div>
                            <div class="form_group">
                                <div class="form_txt">站点描述：</div>
                                <div class="form_input"><textarea name="seodesc" cols="60" rows="4" onKeyUp="strlen_verify(this,'description_len',255)" class="tt"><?php echo ($seoInfo["seodesc"]); ?></textarea>　还可输入<span id="description_len"><?php echo (strlength($seoInfo["seodesc"],255)); ?></span> 个字符　<br><span>META标签的description内容</span></div>
                            </div>
                            <div class="form_group">
                                <div class="form_bnt">
...
<script src="/Public/Admin/js/main.js"></script>
    ...
    <script>
        $(".formname").MotorsSubmit({
            ajaxurl:"<?php echo U('Setting/seoSetting');?>"
        });
    </script>
