...
<div class="main-container" id="main-container">
    ...
    <div class="breadcrumbs" id="breadcrumbs">
        <ul class="breadcrumb">
            ...
            <li><a href="<?php echo U('Slide/index');?>">幻灯片管理</a></li>
            <li>添加幻灯片</li>
        </ul><!-- /.breadcrumb -->
                            ...
                            <div class="form_group">
                                ...
                                <div class="form_input">
                                    <?php if(!empty($info["name"])): echo ($info["name"]); ?>
                                        <?php else: ?>
                                        <input type="text" name="name" size="50" maxlength="20" class="ip" value="<?php echo ($info["name"]); ?>" data-rule="名称:required;letters;" /><span>只能为字母，保存后不能更改</span><?php endif; ?>
                                </div>
                            </div>
                            <div class="form_group">
                                <div class="form_txt">标题：</div>
                                <div class="form_input">
                                    <input type="text" name="title" size="50" maxlength="20" class="ip" value="<?php echo ($info["title"]); ?>" data-rule="标题:required;" ></div>
                            </div>
                            <div class="form_group">
                                <div class="form_bnt">
...
<script src="/Public/Admin/js/main.js"></script>
    ...
    <script>
        $(".formname").MotorsSubmit({
            ajaxurl:"<?php echo U('Slide/add');?>",
            loadurl:"<?php echo U('Slide/index');?>"
        });
    </script>
