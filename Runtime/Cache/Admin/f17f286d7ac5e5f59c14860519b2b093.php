...
<div class="main-container" id="main-container">
    ...
    <div class="breadcrumbs" id="breadcrumbs">
        <ul class="breadcrumb">
            ...
            <li><a href="<?php echo U('Expand/link',array('isprevpage'=>1));?>">友情链接</a></li>
            <li>
                <?php if(!empty($link)): ?>编辑<?php else: ?>添加<?php endif; ?>
            </li>
        </ul><!-- /.breadcrumb -->
                        ...
                        <form class="form-horizontal linkAddForm" method="post">
                            ...
                            <div class="form_group">
                                ...
                                <div class="form_input">
                                    <input type="text" name="webname" size="50" maxlength="50" class="ip" value="<?php echo ($link["webname"]); ?>" data-rule="网站名称:required;webName;" />
                                </div>
                            </div>
                            <div class="form_group">
                                <div class="form_txt">网站域名：</div>
                                <div class="form_input">
                                    <input type="text" name="weburl" size="50" maxlength="255" class="ip" value="<?php echo ($link["weburl"]); ?>" data-rule="网站域名:required;url" />
                                    <span>请以http://或https://开头</span></div>
                            </div>
                            <div class="form_group">
                                <div class="form_txt">网站LOGO：</div>
                                <div class="form_input">
                                    <input type="text" size="50" maxlength="255" class="ip" value="<?php echo (getattachurl($link["weblogoid"])); ?>" disabled/>
                                    <input type="hidden" name="catepicid" value="<?php echo ($link["weblogoid"]); ?>"/>
                                    <input type="button" value="上传" id="upbtn" data-type="1" class="bnt bnt_save" />
                                    <span>可以为空</span>
                                </div>
                                <div class="form_input img-div" <?php if(empty($link["weblogoid"])): ?>style="display:none;"<?php endif; ?>>
                                    <img src="<?php echo (getattachurl($link["weblogoid"])); ?>"/>
                            ...
                            <div class="form_group">
                                ...
                                <div class="form_input" style="width:200px;">
                                    <select name="classid" class="ip beautify_input">
                                        ...
                                        <?php if(is_array($linkclass)): $i = 0; $__LIST__ = $linkclass;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$volinkclass): $mod = ($i % 2 );++$i;?><option value="<?php echo ($volinkclass["classid"]); ?>" <?php if(($volinkclass["classid"]) == $link['classid']): ?>selected<?php endif; ?>><?php echo ($volinkclass["classname"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                    </select>
                            ...
                            <div class="form_group">
                                ...
                                <div class="form_input">
                                    <label class="checklabel">
                                        <input type="checkbox" name="islock" class="ace" value="1" <?php if(($link["islock"]) == "1"): ?>checked="checked"<?php endif; ?>>
                            ...
                            <div class="form_group">
                                <div class="form_bnt">
                                    ...
                                    <a href="<?php echo U('Expand/link',array('isprevpage'=>1));?>" class="btn btn-white btn-warning btn-round">
...
<script src="/Public/Admin/js/main.js"></script>
    ...
    <script>
        var infoId = "<?php echo ($link["id"]); ?>";
        if(infoId){
            var loadurl = "<?php echo U('Expand/link',array('isprevpage'=>1));?>";
        }else{
            var loadurl = "<?php echo U('Expand/link');?>";
        }
        $(".linkAddForm").MotorsSubmit({
            ajaxurl:"<?php echo U('Expand/linkAdd');?>",
            loadurl:loadurl
        });
    </script>
