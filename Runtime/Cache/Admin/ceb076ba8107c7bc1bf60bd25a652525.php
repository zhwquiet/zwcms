                    ...
                    <div class="table_form">
                        <form class="form-horizontal formname" method="post">
                            <div class="form_group">
                                ...
                                <div class="form_input"><input type="text" name="htmldir" size="50" maxlength="50" class="ip" value="<?php echo ($htmlInfo["htmldir"]); ?>" data-rule="生成目录:required;"/><span>为空时生成到根目录，示范："html/"</span></div>
                            </div>
                            <div class="form_group">
                                <div class="form_txt">保存内容时：</div>
                                <div class="form_input">
                                    <label class="checklabel">
                                        <input name="htmlhome" type="checkbox" class="ace" value="1" <?php if($htmlInfo['htmlhome'] == 1): ?>checked<?php endif; ?>>
                                        <span class="lbl"> 生成网站首页</span>
                                    </label>
                                    <label class="checklabel">
                                        <input name="htmlclass" type="checkbox" class="ace" value="1" <?php if($htmlInfo['htmlclass'] == 1): ?>checked<?php endif; ?>>
                                        <span class="lbl"> 生成所属于类别</span>
                                    </label>
                                    <label class="checklabel">
                                        <input name="htmlcontent" type="checkbox" class="ace" value="1" <?php if($htmlInfo['htmlcontent'] == 1): ?>checked<?php endif; ?>>
                                        <span class="lbl"> 生成当前内容</span>
                                    </label>
                                </div>
                            </div>
                            <div class="form_group">
                                <div class="form_txt" style="width:20%;line-height: 32px;text-align:left;">保存内容时候生成列表的数量：</div>
                                <div style="float:left;width:100px;padding: 5px 0;">
                                    <select name="htmltotal" class="ip beautify_input">
                                        <?php $__FOR_START_2066898160__=1;$__FOR_END_2066898160__=11;for($i=$__FOR_START_2066898160__;$i < $__FOR_END_2066898160__;$i+=1){ ?><option value="<?php echo ($i); ?>" <?php if(($htmlInfo["htmltotal"]) == $i): ?>selected<?php endif; ?>><?php echo ($i); ?>页</option><?php } ?>
                                    </select>
                                </div>
                            </div>
                            <div class="form_group">
...
<script src="/Public/Admin/js/main.js"></script>
    ...
    <script>
        $(".formname").MotorsSubmit({
            ajaxurl:"<?php echo U('Setting/htmlSetting');?>"
        });
    </script>
