            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="nav_menu">
                        <ul>
                            <li>
                                <a href="<?php echo U('Nav/classadd');?>">
                                    <span class="icon iconfont icon-liebiaoshouqi"></span>添加导航
                                </a>
                            </li>
                        </ul>
                    </div>
                    <div id="tablelist">
                        <table class="table table-striped table-bordered table-hover">
                            ...
                            <?php if(!empty($list)): if(is_array($list)): $key = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($key % 2 );++$key;?><tr class="item" attr_id="<?php echo ($v["id"]); ?>">
                                        ...
                                        <td class="edit">
                                            <a href="<?php echo U('Nav/index',array('classid'=>$v['id']));?>">菜单管理</a>
                                            <a href="<?php echo U('Nav/classadd',array('id'=>$v['id']));?>">编辑</a>
                                            <?php if(($v['islock']) != "1"): ?><a class="delete" rel="<?php echo U('Nav/classdel',array('id'=>$v['id']));?>">删除</a><?php endif; ?>
                                        </td>
