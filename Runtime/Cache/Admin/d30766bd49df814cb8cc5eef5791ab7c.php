                    ...
                    <div class="table_form">
                        <form class="form-horizontal formname" method="post">
                            ...
                            <div class="form_group">
                                ...
                                <div class="form_input"><input type="text" name="groupname" size="50" maxlength="20" class="ip" data-rule="角色名称:required;" value="<?php echo ($groupInfo["groupname"]); ?>" /></div>
                            </div>
                            <div class="form_group">
                                <div class="form_txt">角色描述：</div>
                                <div class="form_input"><textarea name="groupdesc" cols="60" rows="4" onKeyUp="strlen_verify(this,'t1',50)" class="tt"><?php echo ($groupInfo["groupdesc"]); ?></textarea>　还可输入<span id="t1"><?php echo (strlength($groupInfo["groupdesc"],50)); ?></span> 个字符</div>
                            </div>
                            <div class="form_group">
                                <div class="form_bnt">
...
<script src="/Public/Admin/js/main.js"></script>
    ...
    <script>
        $(".formname").MotorsSubmit({
            ajaxurl:"<?php echo U('System/addGroup');?>",
            loadurl:"<?php echo U('System/groupList');?>"
        });
    </script>
